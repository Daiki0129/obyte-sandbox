...
function handleText(from_address, text, onUnknown){
	...
	switch(command){
     ...
     var arrDefinition = ['or', [
       ['and', [
         ['address', 'HU2IOKMDXCPQFJNRY2HOBN3HDGLJX3BC'], //useraddress
         ['in data feed', [
     ...
     var assocSignersByPath = {
       'r.0.0': {
         address: 'HU2IOKMDXCPQFJNRY2HOBN3HDGLJX3BC', //user_address
...
function setupChatEventHandlers(){
    ...
    console.log(!isControlAddress(from_address));
    // if (!isControlAddress(from_address)){
    // console.log("!isControlAddress(from_address)");
